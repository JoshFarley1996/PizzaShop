...
{
    internal class Veggie
    {
        public string veggie = "Veggie";
        public object[] VeggieArray = { "Mushrooms", "Tomatoes", "Spinach", "Bell Peppers", "Olives", "None" };
        ...
        public static void SelectVeggie(object[] moreselection)
        {
            bool valid = true;
            int chosen;
            int otherchosen;
            ...
            while (valid)
            {
                ...
                {
                    amount = 1;
                    Console.WriteLine($"You get 1 Veggie.");
                }
                else if (Size.sizechoice == 2 || Size.sizechoice == 3)
                {
                    amount = 2;
                    Console.WriteLine($"You get 2 Veggies.");
                }
                else
                {
                    amount = 3;
                    Console.WriteLine($"You get 3 Veggies.");
                }
